window.onload = () => {
  ...
  function openFullscreen() {
    ...
    fullscreenBtn.firstChild.classList.add("fa-compress-alt");
  ...
  function closeFullscreen() {
    ...
    fullscreenBtn.firstChild.classList.remove("fa-compress-alt");
  ...
  class ProgressBar {
    constructor(svg) {
      this.canvas = svg;
      this.lefOffset =
        document.getElementsByClassName("sidenav")[0].getBoundingClientRect()
          .width + 10;
    ...
    trackingAnimation() {
      ...
      this.goToAnimation(1).then(() => {
        this.trackingTargetInterval = setInterval(
